...
function stripAnsi(str: string): string {
	// biome-ignore lint/suspicious/noControlCharactersInRegex: yo shut up
...
export const createLogger = (namespace: string) => {
	...
	return {
		debug: (msg: string, meta: object = {}) => logger.debug(msg, { namespace: ns, ...meta }),
		info: (msg: string, meta: object = {}) => logger.info(msg, { namespace: ns, ...meta }),
		warn: (msg: string, meta: object = {}) => logger.warn(msg, { namespace: ns, ...meta }),
		error: (msg: string, meta: object = {}) => logger.error(msg, { namespace: ns, ...meta }),
